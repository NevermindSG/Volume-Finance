...
fig.suptitle("Volumes Short Term- Indices "+ datestring)
...
#----------------------------------Chart 1
SP500 = yf.download('^GSPC', start='2021-02-01', end=yesterday)
...
NSDQ = yf.download("^NDX", start='2021-02-01', end=yesterday)
...
#------------------------------Chart 3
ETH = pd.DataFrame(data=yf.download("ETH-EUR", start='2021-02-01', end=yesterday))

BTC = pd.DataFrame(data=yf.download("BTC-EUR", start='2021-02-01', end=yesterday))
...
Nikkei225 = yf.download("^N225", start='2021-02-01', end=yesterday)
